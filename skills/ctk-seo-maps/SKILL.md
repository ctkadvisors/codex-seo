...
**Reference:** `references/local-seo-signals.md` for benchmarks (shared with ctk-seo-local).
...
**Reference:** `references/local-schema-types.md` for industry subtypes (shared with ctk-seo-local).
