...
- `https://example.com/blog/ctk-seo-guide` → `blog--seo-guide`
...
| Skill | Reads | Writes |
|---|---|---|
| `ctk-seo-audit` | `site-meta.json`, `audit-scores.json`, page specialist caches during Phase 2 | `site-meta.json`, `audit-scores.json` |
| `ctk-seo-technical` | `site-meta.json` | `pages/{slug}/technical.json` |
| `ctk-seo-content` | `site-meta.json`, `pages/{slug}/geo.json` | `pages/{slug}/content.json` |
| `ctk-seo-schema` | `site-meta.json` | `pages/{slug}/schema.json` |
| `ctk-seo-geo` | `site-meta.json`, `pages/{slug}/technical.json` | `pages/{slug}/geo.json` |
| `ctk-seo-performance` | `site-meta.json` | `pages/{slug}/performance.json` |
| `ctk-seo-visual` | `site-meta.json` | `pages/{slug}/visual.json` |
| `ctk-seo-images` | `site-meta.json` | `pages/{slug}/images.json` |
| `ctk-seo-page` | `site-meta.json`, `pages/{slug}/schema.json`, `pages/{slug}/content.json` | `pages/{slug}/page-analysis.json` |
| `ctk-seo-plan` | `site-meta.json`, `audit-scores.json` | `plan.json` |
| `ctk-seo-sitemap` | `site-meta.json`, `plan.json` | `sitemap.json` |
| `ctk-seo-programmatic` | `site-meta.json`, `sitemap.json` | `programmatic.json` |
| `ctk-seo-competitor-pages` | `site-meta.json`, `plan.json` | `competitors.json` |
| `ctk-seo-hreflang` | `site-meta.json` | `hreflang.json` |
| `ctk-seo-backlinks` | `site-meta.json`, `competitors.json` | `backlinks.json` |
| `ctk-seo-google` | `site-meta.json`, `sitemap.json` | `google.json`, page performance/index data when URL-specific |
| `ctk-seo-local` | `site-meta.json`, `pages/{slug}/geo.json` | `local.json` |
| `ctk-seo-maps` | `site-meta.json`, `local.json` | `maps.json` |
| `ctk-seo-cluster` | `site-meta.json`, `plan.json`, `content.json` | `cluster.json` |
| `ctk-seo-sxo` | `site-meta.json`, `pages/{slug}/content.json` | `sxo.json` |
| `ctk-seo-drift` | `site-meta.json`, prior `drift.json` | `drift.json` |
| `ctk-seo-ecommerce` | `site-meta.json`, `schema.json`, `images.json` | `ecommerce.json` |
| `ctk-seo-flow` | `site-meta.json`, latest specialist caches | `flow.json` |
| `ctk-seo-dataforseo` | `site-meta.json`, active specialist cache | `dataforseo.json` |
| `ctk-seo-firecrawl` | `site-meta.json`, `sitemap.json` | `firecrawl.json` |
| `ctk-seo-image-gen` | `site-meta.json`, `images.json`, `content.json` | `image-gen.json` |
| `ctk-seo` | `site-meta.json`, `audit-scores.json` | none |
