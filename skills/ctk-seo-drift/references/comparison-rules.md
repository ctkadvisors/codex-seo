...
- **Cross-ref**: `$ctk-seo technical <url>`
...
- **Cross-ref**: `$ctk-seo google psi <url>`
...
- **Action**: Positive change. Validate the new schema with `$ctk-seo schema <url>`.
- **Cross-ref**: `$ctk-seo schema <url>`
