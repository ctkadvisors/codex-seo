...
| Skill | Relationship |
|-------|-------------|
| `ctk-seo-plan` | Import source: strategy import reads ctk-seo-plan output |
| `ctk-seo-content` | Quality check: E-E-A-T validation of generated content |
| `ctk-seo-schema` | Schema markup: Article, BreadcrumbList, ItemList for cluster pages |
| `ctk-seo-dataforseo` | Data source: SERP data when DataForSEO MCP is available |
