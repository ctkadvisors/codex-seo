...
Config file: `~/.config/ctk-codex-seo/google-api.json`
```json
{
...
- **ctk-seo-audit**: Spawns `ctk-seo-google` agent for live CWV + indexation data (conditional)
- **ctk-seo-technical**: Uses pagespeed_check.py for real CWV field data
- **ctk-seo-performance**: CrUX field data supplements Lighthouse lab data
- **ctk-seo-sitemap**: GSC sitemap status shows real crawl/index coverage
- **ctk-seo-content**: GSC query data informs keyword targeting
- **ctk-seo-geo**: GSC search appearance data includes AI Overview references
