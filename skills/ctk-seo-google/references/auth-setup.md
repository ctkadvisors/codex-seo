...
| **Both** | Full ctk-seo-google skill | Free |
...
2. Name: `ctk-codex-seo` (or similar)
3. Skip optional permissions steps
4. Click on the created service account > **Keys > Add Key > Create new key > JSON**
5. Download the JSON file and store it securely (e.g., `~/.config/ctk-codex-seo/service_account.json`)
...
```json
{
  "service_account_path": "~/.config/ctk-codex-seo/service_account.json",
  "api_key": "AIzaSy...",
