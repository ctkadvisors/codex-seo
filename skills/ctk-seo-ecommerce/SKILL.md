...
1. Fetch organic rankings via ctk-seo-dataforseo:
...
|-------|------------------|
| **ctk-seo-schema** | Delegates Product schema generation; reuses validation logic |
| **ctk-seo-images** | Product image audit (alt text, format, dimensions) |
| **ctk-seo-content** | Product description E-E-A-T and uniqueness analysis |
| **ctk-seo-dataforseo** | Organic keyword rankings for gap analysis |
| **ctk-seo-technical** | Core Web Vitals for product pages (LCP on hero image) |
| **ctk-seo-google** | Google Merchant Center feed validation via GSC |
