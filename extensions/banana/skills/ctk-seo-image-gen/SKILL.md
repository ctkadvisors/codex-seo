...
```
Load matching preset and apply as defaults. Also check `references/ctk-seo-image-presets.md`
...
- `references/ctk-seo-image-presets.md`:SEO-specific preset templates
